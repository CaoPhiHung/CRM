...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager552c3cfd7e658_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager552c3cfd7e658_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/var/www/html/levis-crm/app/cache/dev/jms_diextra/doctrine/EntityManager_552c3cfd7e658.php';
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager552c3cfd7e658_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($i, $this);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($p, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($d, array(0 => $b, 1 => $c, 2 => new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $b, 1 => $c))), 'main', $a, $e), 2 => $s, 3 => $t, 4 => $u, 5 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($d, $r, $h, $a, $e), 6 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($d, '552c3cfd4680d', $a), 7 => new \Symfony\Component\Security\Http\Firewall\AccessListener($d, $j, $p, $h, $a), 8 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($d, $b, $this->get('security.user_checker'), 'main', $j, $a, '_switch_user', 'ROLE_ALLOWED_TO_SWITCH', $e)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($d, $this->get('security.authentication.trust_resolver'), $q, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($g, $q, '/login', false), NULL, NULL, $a));
    }
     ...
     *
     * @return EntityManager552c3cfd7e658_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/var/www/html/levis-crm/app/cache/dev/jms_diextra/doctrine/EntityManager_552c3cfd7e658.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager552c3cfd7e658_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
