...
";
    ...
    jQuery(function() {
        ...
        // jQuery(\"#form_mari option\").prop('disabled', false);
        // jQuery(\"#form_mari\").prop('required', false);
