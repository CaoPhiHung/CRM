...
class __TwigTemplate_61f77caf072b1bd528dd981f19aeb9eb extends Vietland\AevitasBundle\Helper\AevitasTwigTemplate
{
...
<table class=\"dynamicTable table table-striped table-bordered table-condensed dataTable\" id=\"table-list-store\" aria-describedby=\"DataTables_Table_0_info\">
    ...
    <tbody role=\"alert\" aria-live=\"polite\" aria-relevant=\"all\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            // line 29
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "getAccountsName"), "html", null, true);
            echo "</td>
                <td class=\"center item-price\">";
            // line 30
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "getBilldate"), "html", null, true);
            echo "</td> 
                <td class=\"center item-price\">";
            // line 31
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "getStore"), "html", null, true);
            echo "</td> 
                <td>";
            // line 32
            ...
            echo "</td>
                <td>";
            // line 33
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "getAmount"), "html", null, true);
            echo "</td>
                <td><a class=\"btn btn-action\" target=\"_blank\" href=\"";
            // line 34
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("store_shopping_action", array("ledgerid" => $this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "getLedgerID"), "billno" => $this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "getBillIdNo"))), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Accumulate Point"), "html", null, true);
            echo "</a><br/><a class=\"btn btn-action\" href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("store_update_user", array("ledgerid" => $this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "getLedgerID"), "billno" => $this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "getBillIdNo"))), "html", null, true);
            echo "\">";
...
";
    ...
    {
        return "VietlandStoreBundle:Store:resultsUser.html.twig";
    }
