...
class __TwigTemplate_c66d9f923963781cea342ddd9ff42355 extends Vietland\AevitasBundle\Helper\AevitasTwigTemplate
{
    ...
    <li>";
        // line 10
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Add category"), "html", null, true);
        echo "</li>
</ul>
";
    }
...
;
        ...
        echo "
           ";
        // line 26
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "name"), 'widget', array("attr" => array("placeholder" => $this->env->getExtension('translator')->trans("Name Category."), "class" => "span10")));
        echo "
...
";
    ...
    {
        return "AevitasLevisBundle:GiftArticle:createCategories.html.twig";
    }
