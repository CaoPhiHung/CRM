...
/* AevitasCustomerCodeBundle:Default:edit.html.twig */
class __TwigTemplate_0a3a1d1ff92eb3de5a7ae317664df63b extends Vietland\AevitasBundle\Helper\AevitasTwigTemplate
{
    ...
    <div class=\"block full-block\">
        ...
        <div class=\"control-group\">
            ...
            <div class=\"controls\">
                    ";
        // line 31
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "store"), 'widget');
        echo "
                </div>
            </div>
            ...
            <div class=\"control-group\">
                ...
                <div class=\"controls\">
                    ";
        // line 38
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "prefix"), 'widget');
        echo "
                    </div>
                </div>
                ...
                <div class=\"control-group\">
                    ...
                    ";
        // line 45
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "start"), 'widget');
        echo "
                        </div>
                    </div>
                    ...
                    ";
        // line 52
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "end"), 'widget');
        echo "
                            </div>
                        </div>
...
<table class=\"dynamicTable table table-striped table-bordered table-condensed dataTable\" id=\"table-list-store\" aria-describedby=\"DataTables_Table_0_info\">
    <thead>
        ...
        echo "</th>
            <th class=\"sorting\" role=\"columnheader\" tabindex=\"0\" aria-controls=\"DataTables_Table_0\" rowspan=\"1\" colspan=\"1\">";
        // line 70
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("End"), "html", null, true);
        echo "</th>
            <th class=\"sorting\" role=\"columnheader\" tabindex=\"0\" aria-controls=\"DataTables_Table_0\" rowspan=\"1\" colspan=\"1\">";
        // line 71
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Used"), "html", null, true);
        echo "</th>
        </tr>
    </thead>
    <tbody role=\"alert\" aria-live=\"polite\" aria-relevant=\"all\">
        ...
        // line 75
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["trans"]) ? $context["trans"] : $this->getContext($context, "trans")));
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 76
            echo "            <tr class=\"gradeA remove_item\">
                <td class=\"center item-name\">";
            // line 77
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "created"), "m/d/Y"), "html", null, true);
            echo "</td>
                <td>";
            // line 78
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "start"), "html", null, true);
            echo "</td>
                <td>";
            // line 79
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "end"), "html", null, true);
            echo "</td>
                <td></td>
            </tr>
           ";
    ...
    <div id=\"addtransfer\" class=\"modal hide fade\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">
        ...
        // line 88
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Searching..."), "html", null, true);
        echo "</strong>
        </div>
    ...
    \$(document).ready(function(){
        ...
        \$('.addtransfer').on('click',function(e){
            ...
            \$.ajax({
                url: '";
        // line 134
        echo $this->env->getExtension('routing')->getPath("form_add_transfer");
        echo "'+'/'+formid+'.json',
                dataType: 'json',
                success: function(data){
...
";
    ...
    {
        return "AevitasCustomerCodeBundle:Default:edit.html.twig";
    }
