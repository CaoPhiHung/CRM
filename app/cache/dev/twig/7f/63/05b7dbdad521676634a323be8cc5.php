...
/* VietlandAevitasBundle:Command:BirthdayMail.html.twig */
class __TwigTemplate_7f6305b7dbdad521676634a323be8cc5 extends Vietland\AevitasBundle\Helper\AevitasTwigTemplate
{
    ...
    <body>
        <div><img src=\"";
        // line 7
        echo twig_escape_filter($this->env, ((isset($context["cdn"]) ? $context["cdn"] : $this->getContext($context, "cdn")) . "/bundles/vietlandaevitas/images/birthday_party_card-01.jpg"), "html", null, true);
        echo "\" width=\"945\" /></div>
        <div style=\"font-size:18px;width:1100;margin:auto;line-height:25px;margin-top:-200px\">
            &nbsp;&nbsp;&nbsp;&nbsp;Công ty Thanh Bắc Thời Trang (TBF) xin kính chúc quý khách có một ngày sinh nhật thật ấm áp và vui vẻ bên người thân và gia đình. Kính chúc quý khách bước sang tuổi mới với thật nhiều niềm vui, sức khỏe cùng thành công trong cuộc sống và công việc. 
            <br/>&nbsp;&nbsp;&nbsp;&nbsp;TBF chân thành cảm ơn sự ủng hộ của quý khách hàng trong suốt thời gian qua, TBF luôn phấn đấu để đáp ứng hơn nữa sự mong mỏi và kỳ vọng của quý khách. 
            ";
        // line 11
        if ((twig_length_filter($this->env, (isset($context["content"]) ? $context["content"] : $this->getContext($context, "content"))) > 0)) {
            // line 12
            echo "                <br/>&nbsp;&nbsp;&nbsp;&nbsp;Nhân dịp đặc biệt này, quý khách khi mua sắm trong suốt tháng sinh nhật của mình tại bất kỳ cửa hàng nào của Levi’s trực thuộc TBF sẽ được tích lũy mức điểm ưu đãi theo những hạng thẻ cụ thể sau:
                <br/><table width=\"100%\">
                    <tr>
                        <th>Store</th>
                        <th>Level</th>
    ...
    {
        return "VietlandAevitasBundle:Command:BirthdayMail.html.twig";
    }
