...
class __TwigTemplate_c943c23793d4fd62e4b679c117f32b1f extends Vietland\AevitasBundle\Helper\AevitasTwigTemplate
{
...
<section id=\"userdash\" class=\"clearfix\">
    <div class=\"shadow_wrapper\">
        ...
        if (((isset($context["nextlevel"]) ? $context["nextlevel"] : $this->getContext($context, "nextlevel")) > 0)) {
            ...
            // line 57
            echo "                                <strong>";
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("You need at least 100 purchase points to be an official Star Club member! Make a purchase at any Levis store near you!"), "html", null, true);
            echo "</strong>
                                ";
        } else {
            // line 59
            echo "                                <strong>";
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("You are on top of the world"), "html", null, true);
            echo "</strong>
                                ";
        }
        // line 61
        ...
        // line 63
        echo twig_escape_filter($this->env, (($this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "getQualifyPoint") * 100) / 5000), "html", null, true);
        echo "%\"></div>
                                    </div>
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["clocks"]) ? $context["clocks"] : $this->getContext($context, "clocks")));
        foreach ($context['_seq'] as $context["_key"] => $context["clock"]) {
            // line 72
            echo "                                <div class=\"clockitem\">
                                    ";
            // line 73
            if (($this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "getPoint") < $this->getAttribute((isset($context["clock"]) ? $context["clock"] : $this->getContext($context, "clock")), "getPoint"))) {
                // line 74
                echo "                                    <h3 class=\"avro\">";
                echo $this->env->getExtension('translator')->getTranslator()->trans("Get %points% points to redeem %gift%", array("%points%" => ($this->getAttribute((isset($context["clock"]) ? $context["clock"] : $this->getContext($context, "clock")), "getPoint") - $this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "getPoint")), "%gift%" => $this->getAttribute((isset($context["clock"]) ? $context["clock"] : $this->getContext($context, "clock")), "getName")), "messages");
                echo "</h3>
                                    <div class=\"gift\">
                                        <input class=\"knob\" data-angleOffset=-90 data-angleArc=180 data-max=";
                // line 76
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["clock"]) ? $context["clock"] : $this->getContext($context, "clock")), "getPoint"), "html", null, true);
                echo " data-fgColor=\"#1185b8\" data-bgColor=\"#211f20\" data-width=\"214\" value=\"";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "getPoint"), "html", null, true);
                echo "\" data-thickness=\".1\" data-linecap=round>
                                        <em class=\"led\"></em>
                                        <em class=\"min\">0</em>
                                        <em class=\"max\">";
                // line 79
                ...
                // line 82
                echo "                                    <h3 class=\"avro\">";
                echo $this->env->getExtension('translator')->getTranslator()->trans("You can redeem %gift% right now", array("%gift%" => $this->getAttribute((isset($context["clock"]) ? $context["clock"] : $this->getContext($context, "clock")), "getName")), "messages");
                echo "</h3>
                                    <div class=\"clock\">
                                        <input class=\"knob\" data-angleOffset=-90 data-angleArc=180 data-max=";
                // line 84
        ...
        // line 114
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["wishlist"]) ? $context["wishlist"] : $this->getContext($context, "wishlist")));
        foreach ($context['_seq'] as $context["_key"] => $context["gift"]) {
            // line 115
            echo "                                                <li><img src=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl($this->getAttribute((isset($context["gift"]) ? $context["gift"] : $this->getContext($context, "gift")), "getThumbnail", array(0 => 75, 1 => 75), "method")), "html", null, true);
            echo "\" width=\"75\" height=\"75\"/></li>
                                        ";
        }
        $_parent = $context['_parent'];
...
";
    ...
    {
        return "AevitasLevisBundle:Dashboard:dashboard.html_bk.twig";
    }
