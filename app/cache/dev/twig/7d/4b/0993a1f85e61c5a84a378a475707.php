...
class __TwigTemplate_7d4b0993a1f85e61c5a84a378a475707 extends Vietland\AevitasBundle\Helper\AevitasTwigTemplate
{
...
<section id=\"userdash\" class=\"clearfix\">
    <div class=\"shadow_wrapper\">
        ...
        echo "</strong>
                        ...
                        ";
        // line 53
        if ((twig_length_filter($this->env, (isset($context["logs"]) ? $context["logs"] : $this->getContext($context, "logs"))) > 0)) {
            // line 54
            echo "                        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["order"]) {
                // line 55
                echo "                        <div class=\"table yellow\">
                            ";
                // line 56
                $context["schema"] = $this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "getSchema");
                // line 57
                echo "                            ";
                $context["orderinfo"] = $this->getAttribute((isset($context["schema"]) ? $context["schema"] : $this->getContext($context, "schema")), 0, array(), "array");
                // line 58
                echo "                            ";
                $context["products"] = $this->getAttribute((isset($context["schema"]) ? $context["schema"] : $this->getContext($context, "schema")), 1, array(), "array");
                // line 59
                echo "                            ";
                $context["index"] = 1;
                // line 60
                echo "                            <div>
                                <h3>";
                // line 61
                echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Order Number"), "html", null, true);
                echo ":";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["orderinfo"]) ? $context["orderinfo"] : $this->getContext($context, "orderinfo")), "BillIDNo", array(), "array"), "html", null, true);
                echo "</h3>
                                <span>";
                // line 62
                echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Order Date"), "html", null, true);
                echo ":";
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "created"), "d/m/Y H:i:s"), "html", null, true);
                echo "</span>
                            </div>
                            <div class=\"body static\">
                                <div class=\"logs\">
                                    <table class=\"dynamicTable table table-striped table-bordered table-condensed dataTable\" id=\"table-list-gift\" aria-describedby=\"DataTables_Table_0_info\">
                                        <thead>
                                            <tr role=\"row\">
                                                <th class=\"sorting_asc\" tabindex=\"0\" aria-controls=\"DataTables_Table_0\" rowspan=\"1\" colspan=\"1\" style=\"width: 10%;\">";
                // line 69
                echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Item ID"), "html", null, true);
                echo "</th>
                                                <th class=\"sorting\" tabindex=\"0\" aria-controls=\"DataTables_Table_0\" rowspan=\"1\" colspan=\"1\" style=\"width: 35%;\">";
                // line 70
                echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Item Name"), "html", null, true);
                echo "</th>
                                                <th class=\"sorting\" tabindex=\"0\" aria-controls=\"DataTables_Table_0\" rowspan=\"1\" colspan=\"1\" style=\"width: 15%;\">";
                // line 71
                echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Cost"), "html", null, true);
                echo "</th>
                                                <th class=\"sorting\" tabindex=\"0\" aria-controls=\"DataTables_Table_0\" rowspan=\"1\" colspan=\"1\" style=\"width: 15%;\">";
                // line 72
                ...
                // line 77
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["products"]) ? $context["products"] : $this->getContext($context, "products")), "items", array(), "array"));
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 78
                    echo "                                                <tr>
                                                    <td class=\"center item-name\">";
                    // line 79
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "iCode", array(), "array"), "html", null, true);
                    echo "</td>
                                                    <td class=\"item-image\" style=\"width:20%;\">";
                    // line 80
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "iDesc", array(), "array"), "html", null, true);
                    echo "</td>
                                                    <td class=\"center\">";
                    // line 81
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "iRate", array(), "array"), "html", null, true);
                    echo "</td>
                                                    <td class=\"center\">";
                    // line 82
                    echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "Qty", array(), "array"), 0, ".", ","), "html", null, true);
                    echo "</td>
                                                    <td class=\"center item-price\" colspan=\"2\">";
                    // line 83
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "iValue", array(), "array"), "html", null, true);
                    echo "</td> 
                                                </tr>
                                            ";
                }
                ...
                echo "                                            </tbody>
                                        ...
                                        <span class=\"total\">";
                // line 88
                echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Subtotals"), "html", null, true);
                echo ":<strong>";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["orderinfo"]) ? $context["orderinfo"] : $this->getContext($context, "orderinfo")), "Amount", array(), "array"), "html", null, true);
                echo "đ</strong></span>
                                        <span class=\"total\">";
                // line 89
                echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Earned Points"), "html", null, true);
                echo ":<strong>";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["orderinfo"]) ? $context["orderinfo"] : $this->getContext($context, "orderinfo")), "bpoint", array(), "array"), "html", null, true);
                echo "</strong></span>
                                    </div>
                                </div>
...
";
    ...
    {
        // line 105
        echo "    \$('#table-activity').dataTable({\"bFilter\": false,\"bLengthChange\": false,\"bInfo\":false});
";
    }

    public function getTemplateName()
    {
        return "AevitasLevisBundle:Dashboard:shoppingHistory.html.twig";
    }
