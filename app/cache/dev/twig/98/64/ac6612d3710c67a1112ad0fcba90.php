...
class __TwigTemplate_9864ac6612d3710c67a1112ad0fcba90 extends Vietland\AevitasBundle\Helper\AevitasTwigTemplate
{
    ...
    {
        // line 1
        echo "<div id=\"shopcart\" class=\"shopcart\">
    <div>
        <a href=\"";
        // line 3
        ...
        if (((isset($context["count"]) ? $context["count"] : $this->getContext($context, "count")) < 2)) {
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("items"), "html", null, true);
        } else {
    ...
    {
        return "AevitasLevisBundle:Checkout:renderSumCart.html.twig";
    }
