 ...
 */
class District extends \Vietland\AevitasBundle\Document\District implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'map', 'cityId', 'name', 'range');
    }
