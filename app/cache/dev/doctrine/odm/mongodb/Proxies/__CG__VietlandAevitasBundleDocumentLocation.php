 ...
 */
class Location extends \Vietland\AevitasBundle\Document\Location implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'coordinate', 'name');
    }
