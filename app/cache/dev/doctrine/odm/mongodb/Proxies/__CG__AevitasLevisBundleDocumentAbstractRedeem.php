 ...
 */
class AbstractRedeem extends \Aevitas\LevisBundle\Document\AbstractRedeem implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'user', 'uid', 'store', 'created', 'sid', 'hash', 'auth', 'point', 'bPoint', 'aPoint');
    }
