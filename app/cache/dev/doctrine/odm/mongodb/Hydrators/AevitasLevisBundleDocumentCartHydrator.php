 ...
 */
class AevitasLevisBundleDocumentCartHydrator implements HydratorInterface
{
    private $dm;
    private $unitOfWork;
    private $class;
    ...
    public function hydrate($document, $data, array $hints = array())
    {
        ...
        /** @Many */
        $mongoData = isset($data['gifts']) ? $data['gifts'] : null;
        $return = new \Doctrine\ODM\MongoDB\PersistentCollection(new \Doctrine\Common\Collections\ArrayCollection(), $this->dm, $this->unitOfWork, '$');
        $return->setHints($hints);
        $return->setOwner($document, $this->class->fieldMappings['gifts']);
        $return->setInitialized(false);
        if ($mongoData) {
            $return->setMongoData($mongoData);
        }
        $this->class->reflFields['gifts']->setValue($document, $return);
        $hydratedData['gifts'] = $return;
        ...
        if (isset($data['finish'])) {
            $value = $data['finish'];
            $return = (bool) $value;
            $this->class->reflFields['finish']->setValue($document, $return);
            $hydratedData['finish'] = $return;
        }
