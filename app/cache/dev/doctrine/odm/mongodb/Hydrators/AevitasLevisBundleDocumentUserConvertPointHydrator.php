 ...
 */
class AevitasLevisBundleDocumentUserConvertPointHydrator implements HydratorInterface
{
    private $dm;
    private $unitOfWork;
    private $class;
    ...
    public function hydrate($document, $data, array $hints = array())
    {
        ...
        if (isset($data['vnd'])) {
            $value = $data['vnd'];
            $return = (int) $value;
            $this->class->reflFields['vnd']->setValue($document, $return);
            $hydratedData['vnd'] = $return;
        }
        ...
        if (isset($data['baserate'])) {
            $value = $data['baserate'];
            $return = (float) $value;
            $this->class->reflFields['baserate']->setValue($document, $return);
            $hydratedData['baserate'] = $return;
        }
        return $hydratedData;
    }
}