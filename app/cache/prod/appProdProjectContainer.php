...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['admin.logger_handler'] = new \Monolog\Handler\StreamHandler('/var/www/html/levis-crm/app/logs/prod.admin.log', 200);
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/html/levis-crm/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $a = $this->get('templating.loader');
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/var/www/html/levis-crm/app/cache/prod/assetic/config'), false)));
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'TBF2013', 'host' => 'TBFMSSQL', 'port' => '1433', 'user' => 'crm', 'password' => '123@123a', 'charset' => 'UTF8', 'driver' => 'sqlsrv', 'driverOptions' => array(), 'driverClass' => '\\Realestate\\MssqlBundle\\Driver\\PDODblib\\Driver'), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/var/www/html/levis-crm/app/cache/prod/jms_diextra/doctrine/EntityManager_550bc75c8b894.php';
        $a = $this->get('annotation_reader');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_1888762fa85767e72fa8a1c5c6147bce');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_1888762fa85767e72fa8a1c5c6147bce');
        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_1888762fa85767e72fa8a1c5c6147bce');
        ...
        $h->setProxyDir('/var/www/html/levis-crm/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager550bc75c8b894_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($i, $this);
    }
    ...
    protected function getDoctrineMongodb_Odm_DefaultConfigurationService()
    {
        $a = $this->get('annotation_reader');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2mongodb_default_1888762fa85767e72fa8a1c5c6147bce');
        ...
        $instance->setProxyDir('/var/www/html/levis-crm/app/cache/prod/doctrine/odm/mongodb/Proxies');
        $instance->setProxyNamespace('MongoDBODMProxies');
        $instance->setAutoGenerateProxyClasses(false);
        $instance->setHydratorDir('/var/www/html/levis-crm/app/cache/prod/doctrine/odm/mongodb/Hydrators');
    ...
    {
        return $this->services['fos_facebook.helper'] = new \FOS\FacebookBundle\Templating\Helper\FacebookHelper($this->get('templating'), $this->get('fos_facebook.api'), false, 'en_US', array(0 => 'email', 1 => 'user_birthday', 2 => 'user_mobile_phone', 3 => 'user_address', 4 => 'user_location', 5 => 'publish_actions'), 'TBF Start Club', 'TBF Star Club - Levis', '/media/facebook/tmp/redemption.png', 'Share with your friends to get more point', 'http://www.starclubvn.com/');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/var/www/html/levis-crm/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\FingersCrossedHandler($this->get('monolog.handler.nested'), 300, 0, true, true);
    }
    protected function getMonolog_Handler_NestedService()
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/var/www/html/levis-crm/app/logs/prod.log', 100, true);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($p, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($d, array(0 => $b, 1 => $c, 2 => new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $b, 1 => $c))), 'main', $a, $e), 2 => $s, 3 => $t, 4 => $u, 5 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($d, $r, $h, $a, $e), 6 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($d, '550bc75c56155', $a), 7 => new \Symfony\Component\Security\Http\Firewall\AccessListener($d, $j, $p, $h, $a), 8 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($d, $b, $this->get('security.user_checker'), 'main', $j, $a, '_switch_user', 'ROLE_ALLOWED_TO_SWITCH', $e)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($d, $this->get('security.authentication.trust_resolver'), $q, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($g, $q, '/login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/var/www/html/levis-crm/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/html/levis-crm/app/cache/prod/sessions');
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/var/www/html/levis-crm/app/cache/prod/translations', 'debug' => false));
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('base_template_class' => 'Vietland\\AevitasBundle\\Helper\\AevitasTwigTemplate', 'debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/var/www/html/levis-crm/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/www/html/levis-crm/app/../web', false);
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/var/www/html/levis-crm/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/html/levis-crm/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/html/levis-crm/app/cache/prod',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/html/levis-crm/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'assetic.cache_dir' => '/var/www/html/levis-crm/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/html/levis-crm/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/var/www/html/levis-crm/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/var/www/html/levis-crm/app/cache/prod/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(
            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/var/www/html/levis-crm/app/cache/prod/jms_diextra/doctrine/EntityManager_550bc75c8b894.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager550bc75c8b894_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/var/www/html/levis-crm/app/cache/prod/jms_security',
            ...
            'doctrine_mongodb.odm.proxy_dir' => '/var/www/html/levis-crm/app/cache/prod/doctrine/odm/mongodb/Proxies',
            'doctrine_mongodb.odm.auto_generate_proxy_classes' => false,
            'doctrine_mongodb.odm.hydrator_namespace' => 'Hydrators',
            'doctrine_mongodb.odm.hydrator_dir' => '/var/www/html/levis-crm/app/cache/prod/doctrine/odm/mongodb/Hydrators',
            ...
            'fos_google.app_name' => 'Nhạc Thánh',
