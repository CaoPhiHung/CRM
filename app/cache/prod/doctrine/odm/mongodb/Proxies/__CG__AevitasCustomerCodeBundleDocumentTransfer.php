 ...
 */
class Transfer extends \Aevitas\CustomerCodeBundle\Document\Transfer implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'created', 'start', 'end', 'used');
    }
