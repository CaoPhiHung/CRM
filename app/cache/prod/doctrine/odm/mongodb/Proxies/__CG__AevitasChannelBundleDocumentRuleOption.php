 ...
 */
class RuleOption extends \Aevitas\ChannelBundle\Document\RuleOption implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'type', 'name', 'value', 'id');
    }
