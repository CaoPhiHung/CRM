 ...
 */
class GiftMeta extends \Aevitas\LevisBundle\Document\GiftMeta implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::getPoints($dm);
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'gid', 'count', 'ship', 'name', 'id');
    }
