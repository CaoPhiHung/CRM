 ...
 */
class CronJob extends \Aevitas\ChannelBundle\Document\CronJob implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'type', 'delaytype', 'cmd', 'time', 'times', 'status', 'process');
    }
