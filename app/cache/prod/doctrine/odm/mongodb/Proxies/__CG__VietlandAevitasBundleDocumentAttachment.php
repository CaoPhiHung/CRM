 ...
 */
class Attachment extends \Vietland\AevitasBundle\Document\Attachment implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'path', 'description');
    }
