 ...
 */
class Anniversary extends \Vietland\AevitasBundle\Document\Anniversary implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'date', 'name');
    }
