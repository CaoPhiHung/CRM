 ...
 */
class TrippleDate extends \Aevitas\LevisBundle\Document\TrippleDate implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'date', 'used', 'id');
    }
