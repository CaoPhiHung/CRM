...
namespace Vietland\UserBundle\Service\Google\auth;
...
use Vietland\UserBundle\Service\Google\apiAuthException;
use Vietland\UserBundle\Service\Google\auth\apiLoginTicket;
